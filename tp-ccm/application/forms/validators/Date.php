...
class Tp_Validate_Date extends Zend_Validate_Abstract
{
    ...
    protected $_messageVariables = array(
        'errmsg'  => 'errTpModelDate',
    );
    
    public $errTpModelDate;
    ...
    public function isValid($value)
    {
        ...
        if (!is_string($value)) {
            ...
            try {
                $ladate = new Tp_Model_Date($value, $this->_locale, $this->_sepdate, $this->_septime, $this->_time);
                if ($this->_time) {
                    if (!$ladate->isTime()) {
                ...
                $this->errTpModelDate = $e->getMessage();
