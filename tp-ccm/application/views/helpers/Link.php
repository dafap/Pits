...
class Zend_View_Helper_Link extends Zend_View_Helper_Url
{
    /**
     * Crée un lien de manière plus intuitive que l'aide "Url"
     * Si $params est une chaine, elle doit être correctement composée à la manière de paramètres http ou du mode rewrite
     * Si $params est un tableau, on applique les règles de http_build_query()
     * 
