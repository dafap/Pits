...
class Pits_Model_DbTable_Row_TUser extends Pits_Model_DbTable_Row_Abstract
{
    ...
    {
        $today = Pits_Model_Format::date('YYYY-MM-dd HH:mm:ss');
    ...
    public function save($login = true)
    {
        ...
        if ($login) {
            if (array_key_exists('dateLastLogin', $this->_cleanData)) {
                ...
                $this->_setData('datePreviousLogin', Pits_Model_Format::date('YYYY-MM-dd HH:mm:ss', 'init'));
            }
        }
