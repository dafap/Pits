...
return array(
    ...
    "'%value%' is no valid email address in the basic format local-part@hostname" => "'%value%' n'est pas un email valide dans le format `utilisateur@domaine`",
    "'%hostname%' is no valid hostname for email address '%value%'" => "'%hostname%' n'est pas un nom de domaine valide pour l'adresse email '%value%'",
    ...
    "'%localPart%' can not be matched against dot-atom format" => "'%localPart%' ne correspond pas au format `service.domaine`",
